...
public class WeaknessGUI extends GUI {

	public WeaknessGUI(Player player, HexAttributes _plugin, HPlayer _hplayer)
    {
        super(_plugin.lang.weakness + " Attributes", 54, _plugin); // Must be multiple of 9!
        
        if (plugin.b_weaGui == false) {
        	plugin.b_weaGui=true;
        	//plugin.log("Registering Events: " + "Weakness Attributes");
	...
	public void addItems(HPlayer _hplayer)
    {
        ...
        // -- list out attributes
        int guiSlot = 0;
        for (Weakness a : plugin.configAttributes.types.weakness) {
