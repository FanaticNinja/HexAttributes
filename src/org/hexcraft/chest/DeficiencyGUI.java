...
public class DeficiencyGUI extends GUI {

	public DeficiencyGUI(Player player, HexAttributes _plugin, HPlayer _hplayer)
    {
        super(_plugin.lang.deficiency + " Attributes", 54, _plugin); // Must be multiple of 9!
        
        if (plugin.b_defGui == false) {
        	plugin.b_defGui=true;
        	//plugin.log("Registering Events: " + "Deficiency Attributes");
	...
	public void addItems(HPlayer _hplayer)
    {
        ...
        // -- list out attributes
        int guiSlot = 0;
        for (Deficiency a : plugin.configAttributes.types.deficiency) {
