...
public class MasteryGUI extends GUI {

	public MasteryGUI(Player player, HexAttributes _plugin, HPlayer _hplayer)
    {
        super(_plugin.lang.mastery + " Attributes", 54, _plugin); // Must be multiple of 9!
        
        if (plugin.b_masGui == false) {
        	plugin.b_masGui=true;
        	//plugin.log("Registering Events: " + "Mastery Attributes");
	...
	public void addItems(HPlayer _hplayer)
    {
        ...
        // -- list out attributes
        int guiSlot = 0;
        for (Mastery a : plugin.configAttributes.types.mastery) {
