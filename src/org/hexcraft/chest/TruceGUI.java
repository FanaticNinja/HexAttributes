...
public class TruceGUI extends GUI {

	public TruceGUI(Player player, HexAttributes _plugin, HPlayer _hplayer)
    {
        super(_plugin.lang.truce + " Attributes", 54, _plugin); // Must be multiple of 9!
        
        if (plugin.b_truGui == false) {
        	plugin.b_truGui=true;
        	//plugin.log("Registering Events: " + "Truce Attributes");
	...
	public void addItems(HPlayer _hplayer)
    {
        ...
        // -- list out attributes
        int guiSlot = 0;
        for (Truce a : plugin.configAttributes.types.truce) {
