...
public class PermEffectGUI extends GUI {

	public PermEffectGUI(Player player, HexAttributes _plugin, HPlayer _hplayer)
    {
        super(_plugin.lang.permeffect + " Attributes", 54, _plugin); // Must be multiple of 9!
        
        if (plugin.b_perGui == false) {
        	plugin.b_perGui=true;
        	//plugin.log("Registering Events: " + "PermEffect Attributes");
	...
	public void addItems(HPlayer _hplayer)
    {
        ...
        // -- list out attributes
        int guiSlot = 0;
        for (PermEffect a : plugin.configAttributes.types.permeffect) {
